                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full h-14 bg-card-dark border border-white/10 rounded-2xl px-5 text-white font-bold text-sm uppercase tracking-wider placeholder:text-slate-700 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all"
                            autoFocus
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full h-14 bg-card-dark border border-white/10 rounded-2xl px-5 text-white font-bold text-sm tracking-wider placeholder:text-slate-700 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all"
                        />
                    </div>
