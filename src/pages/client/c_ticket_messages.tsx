...
const C_TicketMessages: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-screen bg-page-dark-01 relative overflow-hidden">
            ...
            <header className="flex items-center gap-4 p-6 border-b border-white/5 bg-[#0c0c0e]/80 backdrop-blur-md sticky top-0 z-20">
                ...
                <div className="flex items-center gap-4">
                    <div className="size-12 bg-blue-600/10 rounded-full border border-blue-500/20 flex items-center justify-center overflow-hidden">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-bold text-blue-500/60 uppercase tracking-[0.2em]">Live Specialist: Dave</p>
                    </div>
                </div>
            </header>
